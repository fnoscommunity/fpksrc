...
echo "DSM Version: $TRIM_SYS_VERSION_MAJOR.$SYNOPKG_DSM_VERSION_MINOR-$SYNOPKG_DSM_VERSION_BUILD"
...
service_prestart () {
    ...
    #  https://github.com/fnoscommunity/fpksrc/blob/e914a32600e65f80131ae09913f1b6f6a2dd8b13/mk/fpksrc.service.installer#L307-L319
