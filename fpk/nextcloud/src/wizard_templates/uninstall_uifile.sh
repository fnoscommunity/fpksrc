...
ERROR_TEXT="{{{NEXTCLOUD_PATH_VALIDATION_ERROR_TEXT}}}"
...
{
	"step_title": "{{{NEXTCLOUD_BACKUP_SERVER_STEP_TITLE}}}",
	"invalid_next_disabled_v2": true,
	"items": [{
		"desc": "{{{NEXTCLOUD_BACKUP_SERVER_DESCRIPTION}}}"
	}, {
		"type": "password",
		...
		"type": "textfield",
		"desc": "{{{NEXTCLOUD_BACKUP_EXPORT_LOCATION_DESCRIPTION}}}",
		"subitems": [{
			"key": "wizard_export_path",
			"desc": "{{{NEXTCLOUD_BACKUP_EXPORT_LOCATION_LABEL}}}",
